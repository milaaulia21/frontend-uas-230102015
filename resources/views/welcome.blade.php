            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/dosen/input">Input Dosen</a>
                        <a class="collapse-item" href="/dosen/index">Lihat Dosen</a>
                    </div>
                </div>
            </li>
            ...
            <li class="nav-item">
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        ...
                        <a class="collapse-item" href="/mahasiswa/input">Input Mahasiswa</a>
                        <a class="collapse-item" href="/mahasiswa">Lihat Mahasiswa</a>
                    </div>
                </div>
            </li>
